...
import { Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, User, UserPlus, CheckCircle } from 'lucide-react';
import bgimg2 from '../assets/signin.jpg'
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(newErrors).length === 0) {
            ...
            try {
                ...
                setErrors({ general: error.message || 'Unable to create account' });
            } finally {
                setIsLoading(false);
            }
        } else {
        ...
        <div className="min-h-screen flex items-center justify-center relative p-4 py-12">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-indigo-200">Join SAUS Platform today</p>
                </div>

                {/* Sign Up Card */}
                <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 p-8">
                    {errors.general && (
                        <div className="flex items-center gap-2 rounded-2xl bg-rose-50 px-4 py-3 text-sm text-rose-600 mb-5">
                        ...
                        <div>
                            <div className="flex items-start">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`h-4 w-4 mt-1 ${errors.agreeTerms ? 'border-red-500' : 'border-gray-300'
                                        } text-indigo-600 focus:ring-indigo-500 rounded cursor-pointer`}
                                />
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-white/95 text-gray-500">Or sign up with</span>
                            </div>
                        </div>
                ...
                <p className="mt-6 text-center text-sm text-white">
                    ...
                    <Link to="/signin" className="font-semibold text-indigo-300 hover:text-indigo-200 transition-colors">
                        Sign in
                    </Link>
                </p>
            </div>
